...
3. User can tap on **"Destination"** to open map with destinations.  
4. User can tap on **"Book a flight"** to open a book a flight screen (empty in this version).  
...
7. User can tap on **"About"** to open an about screen.  
8. User can tap on **"Settings"** to open the app settings screen.  
