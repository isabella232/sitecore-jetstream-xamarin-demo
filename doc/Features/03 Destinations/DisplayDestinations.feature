...
4. User can tap on "Destination" marker to view the destination details.  
...
2. **Name** and **Image** for destinations element are loaded from the Jetstream instance.  
3. User can tap on destination element to view the destination details.  
...
2. **Image** and **Description** for destination are loaded from the Jetstream instance.  
