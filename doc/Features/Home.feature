...
**Primary objectives**  
* Build mobile apps different platforms: iOS, Android.
* Design apps for Tablets only.
* Deliver up-to-date content from Jetstream demo site.
* Use existing Jetstream demo scenarios.
* Use Mobile SDK for Xamarin.
