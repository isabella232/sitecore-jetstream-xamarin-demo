...
RELEASE_DIR="$LAUNCH_DIR/src/ios/JetStreamIOSFull/bin/iPhone/Release"
IPA_FILE="$RELEASE_DIR/JetStreamIOSFull.ipa"
...
function make_ipa_file 
{
	...
	mkdir -p "Payload"
	cp -r  "JetStreamIOSFull.app" "Payload/JetStreamIOSFull.app"
