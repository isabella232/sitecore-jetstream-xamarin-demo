namespace JetstreamAndroid
{
  ...
  public class ActionBarDrawerEventArgs : EventArgs
    ...
    public class JetstreamActionBarDrawerToggle : ActionBarDrawerToggle
    {
        public JetstreamActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout,  int drawerImageRes, int openDrawerContentDescRes, int closeDrawerContentDescRes)
